...
window_size (tuple(int)): Image size should be divisible by window size, 
                     e.g., if image has a size of (128,128,128), then the window size can be (5, 6, 7)
...
img_size (int | tuple(int)): Input image size, e.g., (128,128,128)
'''
